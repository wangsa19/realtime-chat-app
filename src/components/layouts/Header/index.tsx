  ...
  return (
    <header
      className={`w-full rounded-xl bg-transparent ${
        typeof onMenuClick === "function" ? "mb-2 md:mb-0" : "mb-2"
      } ${contact ? "md:mb-2" : ""}`}
    >
      <section
        className={`flex items-center justify-between gap-4 rounded-xl bg-white shadow-md md:px-6  ${
          contact ? "p-4 border border-slate-200" : "p-4 md:p-0"
        }`}
      >
        {/* Sisi Kiri */}
        ...
        {/* Sisi Kanan (hanya tampil jika ada kontak yang dipilih) */}
        {contact && (
